...
class ScoreWindow(Screen):
    def build(self):
        ...
        choix_solve = Button(font_size="25px", font_name="fonts/sackers-gothic-std.otf",text="satisfy", pos_hint={"center_x": .5, "center_y": .7},size_hint=[.15, .07],background_color={1, .3, .4, .85})
        ...
        label_solution_generee = Label(font_size="30px", font_name="fonts/sackers-gothic-std-heavy.otf",
                                       text="Solution générée : ", pos_hint={"center_x": .3, "center_y": .45}, opacity=0)
        ...
        solution_generee = Label(font_size="25px",
                                 pos_hint={"center_x": .4, "center_y": .3}, opacity=0)
